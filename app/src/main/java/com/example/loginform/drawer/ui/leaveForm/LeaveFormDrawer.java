package com.example.loginform.drawer.ui.leaveForm;
...
public class LeaveFormDrawer extends AppCompatActivity {
...
//        textViewSelectDateTo = findViewById(R.id.textViewSelectDateTo);
        ...
        leaveApplyDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(LeaveFormDrawer.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View v) {
                ...
                if ( empNameGet.length() == 0 || empEmailGet.length() == 0 || empDepartGet.length() == 0 || empApplyDateGet.length() == 0 || fromDateGet.length() == 0 || toDateGet.length() == 0 || leaveDescrip.length() == 0) {
                    ...
                    if (true) {
                        ...
                        startActivity(new Intent(LeaveFormDrawer.this, LeaveList.class));
                    } else {
